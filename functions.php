...
function theme_4w4_scripts() {
	...
	//wp_enqueue_style('theme-4w4-fonts', 'https://fonts.googleapis.com/css2?family=Montserrat:wght@500&display=swap', false);
...
// pre_get_post s'execute avant les post, ensuite : variable qui est defini par la function ci-haut
